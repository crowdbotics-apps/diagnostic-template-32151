...
## Project Structure
    ...
    ├── diagnostic_template_32151  # Django project configurations
...
1. Clone this repo and `cd diagnostic_template_32151`
...
2. Clone this repo and `cd diagnostic_template_32151`
